...
class OAuth2Utils(object):
    ...
    @staticmethod
    def parse_auth_code(request):
        return request.GET.get(OAuth2Utils.AUTH_CODE, default=None)

    @staticmethod
    def parse_state(request):
        return request.GET.get(OAuth2Utils.STATE, default=None)
...
class OAuth2RequestBuilder(object):
    ...
    def set_code(self, code):
        self.__params[OAuth2Utils.AUTH_CODE] = code
        return self

    def set_grant_type(self, grant_type):
        self.__params[OAuth2Utils.GRANT_TYPE] = grant_type
        return self

    def set_redirect_uri(self, redirect_uri):
        self.__params[OAuth2Utils.REDIRECT_URI] = redirect_uri
        return self
    ...
    def build(self):
        ...
        if self.__port is not None:
            host_uri += OAuth2RequestBuilder.SEPARATOR_OF_HOST_AND_PORT + str(self.__port)
